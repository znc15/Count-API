...
<html lang="zh-cn">
    ...
    <head>
        ...
        <!-- favicon -->
        <link href="assets/images/wawcloud_icon.svg" rel="shortcut icon" >
        <!-- Bootstrap -->
        ...
        <link href="https://cdn.bootcdn.net/ajax/libs/mdui/1.0.1/css/mdui.min.css" rel="stylesheet" crossorigin="anonymous"/>
        <style>
    ...
    <body>
        ...
        <header id="topnav" class="defaultscroll sticky">
            <div class="container">
                ...
                <div>
                    <a class="logo" href="/">
                        <img src="<?php echo $logoimagedark; ?>" class="l-dark" height="16" alt="">
                        <img src="<?php echo $logoimagelight; ?>" class="l-light" height="16" alt="">
                    </a>
                </div>     
                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu nav-light">
                        ...
                        <ul class="navigation-menu nav-light">
                        <li class="buy-button">
                            <a href="" class="text-dark h6 mr-3 login" >API 文档</a>
                        </ul>
                        </li>
                        
                        <ul class="navigation-menu nav-light">
                        <li class="buy-button">
                            <a href="" class="text-dark h6 mr-3 login" >Q & A</a>
                        </ul>
                        </li>
        ...
        <!-- Home Start -->
        <section class="bg-half-260 d-table w-100 bg-primary" style="background: url('https://api.miaomc.cn/image/get') top center;" id="home">
            <div class="bg-overlay"></div>
            <div class="container">
                <div class="row mt-5 justify-content-center">
                    <div class="col-12">
                        <div class="title-heading text-center">
                            <h4 class="heading text-white mb-3"><?php echo $siteName; ?> - <?php echo $siteInfo; ?></h4>
                            <p class="text-white-50 para-desc mx-auto mb-0">Count Api，做你最好的网站监控者</p>
                        
                            <div class="mt-4">
                                <a href="/home/register.php" class="btn btn-primary mx-1">立刻注册</a>
                                <a href="/home/login.php" class="btn btn-light mx-1">立即登陆</a>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                            ...
                            <div class="row justify-content-center align-items-center">
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="section-title">
                                        <h6 class="text-white mb-3">基于 <?php echo $siteName; ?></h6>
                                ...
                                <div class="col-lg-6 col-md-6 col-12 mt-4 pt-2 mt-sm-0 pt-sm-0">
                                    <ul class="list-unstyled mb-0 ml-lg-5">
                                        <li class="text-white-50 my-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right-circle fea icon-ex-md text-white mr-2">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <polyline points="12 16 16 12 12 8"></polyline>
                                                <line x1="8" y1="12" x2="16" y2="12"></line></svg>稳定快速</li>
                                        <li class="text-white-50 my-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right-circle fea icon-ex-md text-white mr-2">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <polyline points="12 16 16 12 12 8"></polyline
                                                ><line x1="8" y1="12" x2="16" y2="12"></line></svg>不拖累网站加载速度</li>
                                        <li class="text-white-50 my-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right-circle fea icon-ex-md text-white mr-2">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <polyline points="12 16 16 12 12 8"></polyline>
                                                <line x1="8" y1="12" x2="16" y2="12"></line></svg>最安全的数据保护可靠性</li>
                                    </ul>
                                </div><!--end col-->
                            </div><!--end row-->
                        </div><!--end container-->
                ...
                <div class="row text-center">
                    <div class="col-sm-6 col-md-7">
                        <div class="text-sm-left">
                            <p class="mb-0 text-foot">© 2021-2023 <?php echo $siteName; ?>. Design with <i class="mdi mdi-heart text-danger">
                            </i> by <a href="https://www.tcbmc.cc/" target="_blank" class="text-reset">TCB Work</a>.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
